[[github_contrib]]
==== Rascunho de Versão Anterior (Contribuições do GitHub)

Muitos contribuidores ofereceram comentários, correções e acréscimos ao rascunho do lançamento inicial no GitHub. Obrigado a todos por suas contribuições para este livro.
